...
#
# Generated by Vivado on Wed Feb 05 01:08:14 +0900 2020
...
#    "D:/naitou/np1116/microblaze/vivado/vivado.srcs/sources_1/imports/hdl/design_1_wrapper.vhd"
...
set_property location {5 1800 790} [get_bd_cells /axi_ethernetlite_0]
set_property location {5 1800 250} [get_bd_cells /axi_gpio_0]
set_property location {5 1800 90} [get_bd_cells /axi_gpio_1]
set_property location {2 440 1000} [get_bd_cells /axi_intc_0]
set_property location {6 2190 740} [get_bd_cells /axi_quad_spi_0]
set_property location {5 1800 440} [get_bd_cells /axi_timer_0]
set_property location {6 2190 960} [get_bd_cells /axi_uartlite_0]
set_property location {5 1800 630} [get_bd_cells /clk_wiz_0]
set_property location {2 440 590} [get_bd_cells /mdm_1]
set_property location {3 930 590} [get_bd_cells /microblaze_0]
set_property location {4 1400 340} [get_bd_cells /microblaze_0_axi_periph]
set_property location {4 1400 760} [get_bd_cells /microblaze_0_local_memory]
set_property location {6 2190 370} [get_bd_cells /mig_7series_0]
set_property location {6 2190 1130} [get_bd_cells /mii_to_rmii_0]
set_property location {2 440 800} [get_bd_cells /rst_mig_7series_0_83M]
set_property location {6 2190 230} [get_bd_cells /util_vector_logic_0]
set_property location {1 140 780} [get_bd_cells /xlconcat_0]
