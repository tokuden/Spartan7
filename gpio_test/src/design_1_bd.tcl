...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set gpio_op [ create_bd_port -dir O -from 63 -to 0 gpio_op ]
  ...
  # Create instance: gpiotest_0, and set properties
  set block_name gpiotest
  set block_cell_name gpiotest_0
  if { [catch {set gpiotest_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $gpiotest_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create port connections
  connect_bd_net -net clk_wiz_0_clk_out50 [get_bd_pins clk_wiz_0/clk_out50] [get_bd_pins gpiotest_0/clk]
  connect_bd_net -net gpiotest_0_gpio_op [get_bd_ports gpio_op] [get_bd_pins gpiotest_0/gpio_op]
  connect_bd_net -net gpiotest_0_led_op [get_bd_ports led_op] [get_bd_pins gpiotest_0/led_op]
  connect_bd_net -net pushsw_ip_1 [get_bd_ports pushsw_ip] [get_bd_pins gpiotest_0/pushsw_ip]
